...
**Release directory:** [specs/releases/X.XX-name/](X.XX-name/)

### Added

- <what shipped, plain description> ([specs/features/00N-name.md](../features/00N-name.md))

### Changed

- <what changed in existing behavior, and why> ([specs/features/00N-name.md](../features/00N-name.md))

### Fixed

- <what was broken and now isn't> ([specs/features/00N-name.md](../features/00N-name.md) or issue link)

### Security

- <any security-relevant change — credential handling, auth, access control> ([specs/features/00N-name.md](../features/00N-name.md))

### Deferred

- <anything explicitly scoped out of this release that was originally planned for it, and where it now lives> ([specs/research/NNN-name.md](../research/NNN-name.md) or roadmap §N)
